...
use crate::interface::CecError;
use crate::power_status::CecPowerStatus;

/// A request the DBus interface makes to the background task for interacting with the CEC connection.
#[derive(Debug)]
pub enum CecRequest {
